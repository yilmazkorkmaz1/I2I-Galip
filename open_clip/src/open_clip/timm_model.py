...
class TimmModel(nn.Module):
    ...
    def get_intermediate_features_clip(self, x, n, return_class_token=True, norm=True):
        return self.trunk.get_intermediate_layers(x,n,return_prefix_tokens=return_class_token,norm=norm)